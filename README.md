...
Xi 程序本身便是以 xi 所支持的文学编程方式实现的，程序源码文件 xi.c 便是从其文学程序文件的源码抽取结果，但是 xi 的文学程序及其文档，目前我还不舍得公诸于众。不过，我为 xi 的背景以及用法写了几篇更为详细的文档，如下：

* [Xi 的前世与今生](https://zhuanlan.zhihu.com/p/2065001920486496163)
* [ConTeXt 和 Xi](https://zhuanlan.zhihu.com/p/2065060352019130215)
* [程序的时空](https://zhuanlan.zhihu.com/p/2065127451601249426)
* [Xi 的两个细微之处](https://zhuanlan.zhihu.com/p/2065363044478325603)
* [我说 Xi，即非 Xi，是名 Xi](https://zhuanlan.zhihu.com/p/2065421411066425620)
